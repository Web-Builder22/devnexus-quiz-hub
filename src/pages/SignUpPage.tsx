...
import { BrainCircuit, Mail, Lock, AlertCircle, ArrowRight, User } from 'lucide-react';
      ...
      <div className="w-full max-w-md space-y-8 bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
        ...
        {success ? (
          <div className="rounded-md bg-green-50 p-4 border border-green-200 text-center">
            <h3 className="text-sm font-medium text-green-800 mb-2">Account created successfully!</h3>
            <p className="text-sm text-green-700 mb-4">Please check your email to verify your account.</p>
            <Link to="/login" className="font-semibold text-indigo-600 hover:text-indigo-500">
              Return to Sign In <ArrowRight className="inline h-4 w-4" />
            </Link>
          </div>
        ) : (
          <>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <button
                      ...
                      className={`py-2.5 px-3 rounded-lg text-sm font-semibold border flex items-center justify-center gap-2 transition-all ${
                        role === 'student'
