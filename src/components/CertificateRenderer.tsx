    ...
    >
      ...
      {!hasBg && (
        <div className="absolute inset-0 pointer-events-none border-[2cqi] border-double border-slate-200">
          ...
          <div className="absolute top-[4cqi] w-full flex justify-center">
            <DevNexusLogo className="h-[18cqi] w-auto object-contain drop-shadow-2xl" />
          </div>

          {/* Title Area (Smaller font & adjusted) */}
          <div className="absolute top-[22cqi] w-full flex flex-col items-center text-center">
